...
const EditQuestionSection: React.FC<Props> = ({ survey, open, questionIndex, form, onClose, onSubmit, onChange, onOptionChange, onAddOption, onRemoveOption, loading }) => {
  return open && questionIndex >= 0 ? (
    <EditSurveyQuestionModal
      ...
      defaultQuestionPoints={survey.scoringSettings?.customScoringRules?.defaultQuestionPoints || 1}
