...
const CollectionModal: React.FC<CollectionModalProps> = ({
	...
	const createCollection = (payload: CollectionCreateRequest) =>
		(collectionsApi?.createCollection || hookApi.createCollection)(payload);
	const updateCollection = (id: string, payload: Partial<Collection>) =>
		(collectionsApi?.updateCollection || hookApi.updateCollection)(id, payload as any);
			...
			<div className='bg-white rounded-lg shadow-lg w-full max-w-3xl p-4 sm:p-6'>
				<div className='flex items-start justify-between gap-4'>
					<h3 className='text-lg font-semibold'>
						{collection
							? t('admin:collections.editTitle', 'Edit Collection')
							: t('admin:collections.createTitle', 'Create Collection')}
					</h3>
					...
					<div className='space-y-3'>
						<div>
							<label className='block text-sm font-medium mb-1'>
								{t('translation:common.name', 'Name')}
							</label>
							<input
								...
								placeholder={t(
									'admin:collections.namePlaceholder',
									'Collection name'
								)}
							/>
						</div>
						<div>
							<label className='block text-sm font-medium mb-1'>
								{t('translation:common.description', 'Description')}
							</label>
							<textarea
								className='input-field w-full'
								rows={3}
								...
								placeholder={t(
									'admin:collections.descriptionPlaceholder',
						...
						<div>
							...
							<div className='flex gap-2'>
								<input
									...
									placeholder={t(
										'admin:collections.tagPlaceholder',
										'Add a tag and press +'
									)}
								/>
				...
				<div className='flex justify-end gap-2 mt-6'>
					...
					<button className='btn-primary' onClick={onSubmit} disabled={saving}>
						{collection
							...
							: t('translation:buttons.create', 'Create')}
					</button>
				</div>
			</div>
		</div>
