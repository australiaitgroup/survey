            ...
            <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                    <p className="text-sm text-gray-600">
                        Copying from: <span className="font-medium text-gray-800">{sourceBankTitle}</span>
                    </p>
                    <p className="text-sm text-gray-600">
                        Questions to copy: <span className="font-medium text-gray-800">{questionIds.length}</span>
                    </p>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    {showCreateNew ? (
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                {loading ? 'Creating and Copying...' : 'Create Bank and Copy Questions'}
                            </button>
                        </div>
                    ) : (
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="max-h-60 overflow-y-auto border border-gray-200 rounded-lg">
                                {filteredBanks.length === 0 ? (
                                    <div className="p-4 text-center text-gray-500">
                                        {searchTerm ? 'No banks match your search' : 'No question banks found'}
                                    </div>
                                ) : (
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    {loading ? 'Copying...' : `Copy ${questionIds.length} Question${questionIds.length !== 1 ? 's' : ''}`}
                                </button>
