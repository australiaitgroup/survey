				...
				{question.isPreview && (
					<div className='p-3 rounded-lg bg-amber-50 border border-amber-200'>
						<p className='text-amber-800 text-sm'>
							🔒 This is a preview. Purchase or subscribe to access all questions and
							answers.
						</p>
					</div>
				)}
					...
					<>
						...
						<div className='flex items-center justify-between pb-4 border-b'>
							...
							<div className='flex items-center gap-2'>
								...
								{previewData.hasAccess && onCopyQuestions && (
									...
									>
										{selectedQuestions.size === previewData.questions.length
											? 'Deselect All'
											: 'Select All'}
									</button>
								)}
								...
								<div className='flex items-center justify-between pt-4 border-t'>
									...
									<button
										onClick={() =>
											setCurrentQuestionIndex(
												Math.min(
													previewData.questions.length - 1,
						...
						<div className='flex items-center justify-between pt-4 border-t'>
							...
							{previewData.hasAccess &&
								...
								>
										Copy {selectedQuestions.size} Question
									{selectedQuestions.size !== 1 ? 's' : ''} to My Bank
								</button>
							)}
						</div>
					</>
