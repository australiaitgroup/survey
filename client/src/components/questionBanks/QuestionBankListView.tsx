	...
	return (
		<div className='space-y-6'>
			<div className='flex justify-between items-center'>
				<h2 className='text-xl font-semibold text-gray-800'>{t('questionBanks.title', 'My Question Banks')}</h2>
				...
				<div className='space-y-6'>
					...
					<div className='text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300'>
						<div className='max-w-md mx-auto'>
							...
							<p className='text-gray-500 mb-6'>
								{t('questionBanks.empty.description', 'Create your first question bank to organize your questions and build surveys.')}
							</p>
					...
					{recommendedBanks.length > 0 && (
						<div className='space-y-4'>
							<div className='flex justify-between items-center'>
								<h3 className='text-lg font-medium text-gray-800'>Recommended Question Banks</h3>
								<button 
						...
						<div className='space-y-4'>
							<div className='flex justify-between items-center'>
								<h3 className='text-lg font-medium text-gray-800'>
									已购买的题库
									<span className='ml-2 text-sm text-gray-500'>({purchasedBanks.length})</span>
								</h3>
								<button 
									className='text-blue-600 hover:text-blue-800 text-sm font-medium'
									onClick={handleGoToMarketplace}
