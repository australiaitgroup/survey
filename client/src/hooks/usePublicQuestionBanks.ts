...
export const usePublicQuestionBanks = () => {
    ...
    const fetchPublicBanks = useCallback(async (params: PublicBanksParams = {}) => {
        ...
        try {
            ...
            if (response.data && response.data.banks) {
                    ...
                    banks: [
                        {
                            ...
                            description: 'Comprehensive question bank covering JavaScript basics including variables, functions, arrays, objects, and ES6+ features. Perfect for beginners and intermediate developers.',
                        ...
                        },
                        {
                            ...
                            description: 'Advanced React patterns including hooks, context, performance optimization, and architectural best practices for scalable applications.',
                        ...
                        },
                        {
                            _id: '4',
                            title: 'Python Basics',
                            description: 'Introduction to Python programming language covering syntax, data types, control structures, and basic libraries.',
                        ...
                        },
                        {
                            ...
                            description: 'Prepare for system design interviews with questions on scalability, distributed systems, microservices, and architectural patterns.',
                        ...
                        },
                        {
                            _id: '6',
                            title: 'SQL Mastery',
                            description: 'Master SQL with questions covering queries, joins, indexes, transactions, and database optimization techniques.',
                ...
                if (params.type && params.type !== 'all') {
                    filteredBanks = filteredBanks.filter(bank => 
                        bank.type.toLowerCase() === params.type
                    );
                }
    ...
    const searchPublicBanks = useCallback((params: PublicBanksParams) => {
