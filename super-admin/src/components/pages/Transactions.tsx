...
const Transactions: React.FC = () => {
  ...
  const filteredTransactions = transactions.filter(transaction => {
    ...
    if (searchTerm) {
      matches = transaction.companyName.toLowerCase().includes(searchTerm.toLowerCase()) ||
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Monitor all financial transactions across the platform</p>
          </div>
        ...
        {filteredTransactions.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchTerm ? 'No transactions match your search.' : 'No transactions have been processed yet.'}
            </p>
          </div>
        ) : (
