					...
					<div className="p-8 text-center">
						...
						<p className="mt-1 text-sm text-gray-500">
							{searchTerm
								...
								: 'Create your first public question bank to get started.'}
						</p>
						{!searchTerm && (
							<button
								onClick={handleCreateBank}
								...
								{filteredBanks.map(bank => (
									<tr key={bank._id}>
										<td className="px-6 py-4 whitespace-nowrap">
											<div>
												...
												<div
													...
													title={bank.description || undefined}
												>
													{bank.description
														? truncateText(bank.description, 30)
														: 'No description'}
												</div>
											</div>
										</td>
										...
										<td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
											{bank.type === 'paid'
												? (bank.priceOneTime || 0).toLocaleString(
													undefined,
													{
														style: 'currency',
														currency: 'USD',
