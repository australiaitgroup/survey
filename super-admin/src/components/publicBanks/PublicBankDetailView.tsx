              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <dl className="space-y-2">
                      <div>
                        ...
                        <dd className="font-medium">{bank.locales?.join(', ') || 'en'}</dd>
                      </div>
                      <div>
                  ...
                  <div>
                    ...
                    <dl className="space-y-2">
                      <div>
                        <dt className="text-sm text-gray-600">Times Used</dt>
                      ...
                      <div key={idx} className="bg-gray-50 rounded-lg p-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              <span className="font-medium text-gray-800">
                                {(currentPage - 1) * questionsPerPage + idx + 1}. {question.text}
                              </span>
                              <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">
                                {question.type === 'multiple_choice' ? 'Multiple Choice' :
                                 question.type === 'single_choice' ? 'Single Choice' : 'Short Text'}
                              </span>
                        ...
                        {question.explanation && (
                          <div className="mt-3 p-3 bg-blue-50 border-l-4 border-blue-200 rounded">
                            ...
                            <div className="text-blue-700 text-sm mt-1">{question.explanation}</div>
                          </div>
                        )}
                      </div>
                    ))}
