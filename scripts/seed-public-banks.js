...
const sampleBanks = [
    {
        ...
        description: 'Comprehensive question bank covering JavaScript basics including variables, functions, arrays, objects, and ES6+ features. Perfect for beginners and intermediate developers looking to solidify their understanding of core JavaScript concepts.',
        type: 'free',
    ...
    },
    {
        ...
        description: 'Advanced React patterns including hooks, context, performance optimization, and architectural best practices for building scalable applications. Covers modern React development techniques and common interview topics.',
        type: 'paid',
        priceOneTime: 29.99,
        currency: 'USD',
    ...
    {
        title: 'Python Basics',
        description: 'Introduction to Python programming language covering syntax, data types, control structures, and basic libraries. Ideal for programming beginners and those transitioning from other languages.',
        type: 'free',
        ...
        questions: [
            ...
            },
            {
                ...
                type: 'single_choice',
                options: ["<class 'array'>", "<class 'list'>", "<class 'collection'>", "<class 'sequence'>"],
                correctAnswer: 1,
                points: 1,
                difficulty: 'easy',
    ...
    },
    {
        ...
        description: 'Comprehensive preparation for system design interviews covering scalability, distributed systems, microservices, database design, and architectural patterns. Based on real interview questions from top tech companies.',
        type: 'paid',
        priceOneTime: 79.99,
        currency: 'USD',
    ...
    {
        title: 'SQL Mastery',
        description: 'Master SQL with comprehensive coverage of queries, joins, indexes, transactions, stored procedures, and database optimization techniques. Suitable for both beginners and experienced developers.',
        type: 'free',
    ...
    },
    {
        ...
        description: 'Essential computer science concepts covering arrays, linked lists, trees, graphs, sorting algorithms, searching algorithms, and complexity analysis. Perfect for technical interviews and competitive programming.',
        type: 'paid',
        priceOneTime: 49.99,
        currency: 'USD',
...
async function seedPublicBanks() {
    try {
        ...
        createdBanks.forEach((bank, index) => {
            console.log(`${index + 1}. ${bank.title} (${bank.type.toUpperCase()}) - ${bank.questions.length} questions`);
        });
